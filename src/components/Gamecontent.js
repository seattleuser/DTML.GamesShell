...
class Gamecontent extends Component {
  ...
  render() {
   ...
   let video= this.props.gameContent.gameVideoID && this.props.gameContent.gameVideoID !='' && this.props.config.howtoplayvideo && (
      <div>
        <ModalVideo channel='youtube' origin='dtml.org' autoplay=0 isOpen={this.state.isOpen} videoId={this.props.gameContent.gameVideoID} onClose={() => this.setState({isOpen: false})} />
